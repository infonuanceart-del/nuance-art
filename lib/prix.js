import { cadreProduit } from './taxonomie.js';
...
/** Prix d'une taille donnée, supplément du cadre de l'œuvre compris, remise appliquée. */
export function prixTaille(produit, taille, cadre = 'aucun') {
  const base = (taille?.prix || produit?.prixMin || 0) + (cadreProduit(produit, cadre)?.supp || 0);
