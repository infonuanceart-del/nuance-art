...
/** Meme chose, sans jeton : la photo d'un client qui n'a pas de compte. */
export async function envoyerFichierPublic(chemin, formData) {
  return appeler(chemin, { method: 'POST', brut: formData });
}
